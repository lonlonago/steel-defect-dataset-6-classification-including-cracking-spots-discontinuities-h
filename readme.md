# Steel Defect Dataset】6-Classification Including Cracking Spots Discontinuities Holes on the Surface.

# Body

Steel Defect Dataset】6-class, including cracks, spots, inclusions, indentations on the surface, rolled flakes, scratches. This data is sourced from Northeastern University. The dataset is divided into 7:2:1 ratio. Among them, there are 1260 images in the training set, 360 images in the validation set, and 180 images in the test set. All image samples are labeled with YOLO under txt format. , and you can directly train with the data.
